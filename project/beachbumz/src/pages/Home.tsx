...
const Home = () => {
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 fade-in-up" style={{ animationDelay: '0.9s' }}>
            ...
            <button onClick={handleOrderClick} className="btn-secondary w-full sm:w-auto flex items-center justify-center space-x-2">
  ...
  <div className="wave wave-front"></div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-on-scroll slide-in-left">
              <h2 className="font-display text-4xl md:text-5xl text-ocean-blue mb-6">
                Welcome to Paradise
              </h2>
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                Step into Beach Bumz Pub & Pizzeria, where every meal feels like a coastal escape. 
                Located in the heart of Morehead City, we're serving up fresh pizzas, crispy wings, 
                hearty subs, and ice-cold drinks that capture the spirit of beach living.
              </p>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
                Now with our liquor license, we're bringing you craft cocktails and premium spirits 
                to complement our comfort food favorites. Whether you're a local or just visiting, 
                Beach Bumz is your home away from home.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12 animate-on-scroll zoom-in">
            ...
            <a 
              ...
              className="inline-flex items-center space-x-2 text-turquoise hover:text-sunset-orange transition-colors duration-300 bounce-subtle"
            >
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-sunset-orange to-coral-pink">
        <div className="max-w-4xl mx-auto text-center px-4 animate-on-scroll zoom-in">
          <h2 className="font-display text-4xl md:text-5xl text-white mb-6">
            Ready to Dive In?
          </h2>
          <p className="text-xl text-white/90 mb-8">
            Experience the best coastal dining Morehead City has to offer
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link to="/menu" className="bg-white text-sunset-orange hover:bg-gray-100 font-semibold py-4 px-8 rounded-none transition-all duration-300 transform hover:scale-105 hover:shadow-xl hover:rotate-1 w-full sm:w-auto">
              Explore Our Menu
            </Link>
            <button onClick={handleOrderClick} className="border-2 border-white text-white hover:bg-white hover:text-sunset-orange font-semibold py-4 px-8 rounded-none transition-all duration-300 transform hover:scale-105 hover:-rotate-1 w-full sm:w-auto">
              Order Now
            </button>
          </div>
        </div>
