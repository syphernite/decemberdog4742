...
const DEMOS: Demo[] = [/* unchanged list */];
    ...
    >
      ...
      {!inView ? (
        ...
        <div className="h-[460px] sm:h-[520px] w-full flex flex-col items-center justify-center text-center p-6">
          <MonitorSmartphone className="h-8 w-8 text-slate-300 mb-2" />
          ...
          <div className="w-full max-w-md hidden">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 rounded-lg border border-white/10 bg-white/10 backdrop-blur text-sm outline-none focus:ring-2 focus:ring-emerald-500"
              />
            </div>
          </div>
