...
/**
 * /pricing — Solar orbit layout (performance-optimized + synced labels)
 * - Local header with “Our Work” link
 * - Static star background (no animated gradients)
 * - Single orbit animation via CSS custom property --a
 * - Labels counter-rotate using the same --a (no per-planet animations)
...
const BG_URL = "/assets/pricing-stars.jpg"; // Update if you place the star image elsewhere
...
const LocalHeader: React.FC = () => {
  ...
  const navItems = [
    ...
    { label: "Our Work", path: "https://built4you.org/#/demos" }, // new
        ...
        <div className="relative z-0 hidden sm:flex items-center justify-center pt-6 pb-8 sm:pb-12">
          ...
          <div className="relative w-[92vw] max-w-[1120px] aspect-square" style={{ willChange: "transform", transform: "translateZ(0)" }}>
            ...
            <div
              ...
              style={{
                animation: animEnabled ? "orbitVar 32s linear infinite" : "none",
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Counter-rotate purely by the same --a */}
                        <div
