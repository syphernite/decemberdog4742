      ...
      <div className="relative z-10 w-full max-w-5xl text-center">
        <div className="inline-block rounded-2xl bg-black/20 backdrop-blur-sm px-5 py-2">
          <h1 className="text-4xl md:text-6xl font-extrabold leading-tight text-white">
            Custom Websites for <span className="bg-gradient-to-r from-emerald-300 to-sky-300 bg-clip-text text-transparent">Small Businesses</span>
          </h1>
        </div>
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4">
            <div className="text-2xl font-bold text-emerald-300"><CountUp to={50} duration={1.2} />+</div>
            <div className="text-slate-200/80 text-sm">Projects Delivered</div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4">
            <div className="text-2xl font-bold text-emerald-300"><CountUp to={100} duration={1.2} delay={0.15} />%</div>
            <div className="text-slate-200/80 text-sm">Client Satisfaction</div>
          </div>
          <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm px-5 py-4">
            <div className="text-2xl font-bold text-emerald-300"><CountUp to={7} duration={1.2} delay={0.3} /> Days</div>
