      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${
                selectedCategory === category
                  ...
                  : 'bg-neutral-900/70 backdrop-blur-sm text-gray-200 hover:bg-white/10 border border-white/10'
              }`}
            >
              {category}
            </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {filteredItems.map((item, index) => (
            <div
              key={index}
              className="bg-neutral-900/70 backdrop-blur-sm p-6 rounded-lg border border-white/10 hover:border-amber-500/50 transition-all hover:shadow-lg"
            >
        ...
        {/* Specials Note */}
        <div className="bg-amber-500/15 backdrop-blur-sm border border-amber-500/30 rounded-lg p-6 text-center">
