...
export default function Home({ onNavigate }: HomeProps) {
  ...
  return (
    <div className="pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              ...
              className="bg-amber-500 text-charcoal px-8 py-4 rounded-lg font-bold text-lg hover:shadow-lg hover:shadow-amber-500/30 transition-all duration-200 hover:-translate-y-1"
            >
              Call Now
            </a>
            <button
              onClick={scrollToMap}
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold text-lg hover:bg-white hover:text-charcoal transition-all duration-200"
            >
              Get Directions
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {businessConfig.features.map((feature, index) => {
              ...
              return (
                <div key={index} className="bg-neutral-900/70 backdrop-blur-sm p-6 rounded-lg border border-white/10 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            {menuItems.map((item, index) => (
              <div key={index} className="bg-neutral-900/70 backdrop-blur-sm p-6 rounded-lg border border-white/10 hover:border-amber-500/50 transition-all">
          ...
          <div className="text-center">
            <button
              ...
              className="bg-amber-500 text-charcoal px-8 py-3 rounded-lg font-semibold hover:shadow-lg hover:shadow-amber-500/30 transition-all"
            >
              View Full Menu
            </button>
          </div>
      ...
      {/* Live Events Banner */}
      <section className="py-12 bg-red-600/20 backdrop-blur-sm border border-red-500/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-white mb-6">Live Events</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {businessConfig.liveEvents.map((event, index) => (
                <div key={index} className="bg-neutral-900/70 backdrop-blur-sm p-4 rounded-lg border border-white/10">
            ...
            <button
              ...
              className="mt-6 bg-white text-red-500 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              View All Events
            </button>
          </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <HoursTable />
            <div id="map-section" className="bg-neutral-900/70 backdrop-blur-sm rounded-lg p-6 border border-white/10">
              <div className="flex items-center mb-4">
                <MapPin className="w-6 h-6 text-amber-500 mr-2" />
                <h3 className="text-xl font-bold text-white">Location</h3>
              </div>
              <p className="text-gray-300 mb-4">{businessConfig.address}</p>
              <div className="bg-black/30 backdrop-blur-sm rounded-lg p-8 text-center border border-white/10">
                ...
                <a
                  ...
                  className="inline-flex items-center text-amber-500 hover:text-amber-400 hover:underline"
                >
                  Open in Google Maps
