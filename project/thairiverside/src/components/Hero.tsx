    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-12 max-w-3xl mx-auto leading-relaxed animate-slide-up text-gray-100 font-light" style={{ animationDelay: '0.2s' }}>
          Replace this copy with your brand message and key highlights.
          <span className="block mt-2 text-lg text-gray-300">
            Indoor seating • Patio friendly • Online ordering available
          </span>
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.4s' }}>
          ...
          >
            <span className="relative z-10">View Sample Menu</span>
      ...
      {/* Scroll Indicator */}
      <div
        className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white/80 animate-bounce-subtle cursor-pointer hover:text-accent-300 transition-colors"
