      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-16">
          ...
          <p className="mt-3 text-white/80 max-w-2xl">
            We host free haircut events for neighbors in need. Coverage by KSWO highlighted this mission of service.
          </p>
          <a
            href="https://www.kswo.com/2025/06/19/good-news-local-barber-aims-help-community-with-free-cuts-those-need/"
            target="_blank" rel="noreferrer"
            className="inline-flex items-center gap-2 mt-5 px-4 py-2 rounded-xl bg-white/10 hover:bg-white/15"
          >Read the KSWO story <ExternalLink size={16}/></a>
        </div>
      </div>
