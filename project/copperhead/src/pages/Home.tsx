      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-20 pb-24 grid md:grid-cols-2 items-center gap-10">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .7 }} className="text-bone">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href="https://booksy.com/en-us/1282324_copperhead-cutz_barber-shop_32141_lawton" target="_blank" rel="noreferrer" className="btn-shine px-5 py-3 rounded-xl bg-white/10 hover:bg-white/15 text-white font-semibold">Book on Booksy</a>
            <Link to="/gallery" className="px-5 py-3 rounded-xl" style={{ backgroundColor: 'var(--copper-600)', color: 'white' }}>View Gallery</Link>
          </div>
