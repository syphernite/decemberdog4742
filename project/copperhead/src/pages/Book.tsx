  ...
  return (
    <section className="min-h-[92svh] bg-ink text-bone grid place-items-center px-6">
      <div className="max-w-2xl text-center">
        ...
        <a href="https://booksy.com/en-us/1282324_copperhead-cutz_barber-shop_32141_lawton" target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 mt-5 px-5 py-3 rounded-xl bg-white/10 hover:bg-white/15">
