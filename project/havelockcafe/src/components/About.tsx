export default function About() {
  return (
    <section className="py-20 px-4 bg-[#B0E0E6]/10">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="font-chalk text-4xl sm:text-5xl text-[#89CFF0] mb-6">
          Where Neighbors Become Friends
        </h2>
        <div className="w-24 h-1 bg-[#B0E0E6] mx-auto mb-8" />
        <p className="text-lg sm:text-xl text-[#B0E0E6] leading-relaxed mb-6">
        ...
        <p className="text-lg sm:text-xl text-[#89CFF0] leading-relaxed">
